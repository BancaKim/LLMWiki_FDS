...
type: Index
title: 논문 모음 (Papers)
description: 2024–2026 GNN × FDS 논문 24편을 6개 주제로 분류한 concept 모음.
tags: [papers, index, gnn, fds, 2024, 2025, 2026]
...
GNN과 FDS를 연계한 **2024–2026** 논문 24편입니다. 각 논문은 `문제 → 방법 → 기여 → 결과 → 링크`
양식의 concept 문서입니다.

## 주제별 디렉터리
| 주제 | 논문 수 | 바로가기 |
|------|:------:|----------|
| 📊 서베이·리뷰 | 3 | [surveys/index.md](surveys/index.md) |
| 💳 신용카드·거래 사기 | 8 | [credit-card-fraud/index.md](credit-card-fraud/index.md) |
| 🤖 LLM × GNN | 4 | [llm-gnn/index.md](llm-gnn/index.md) |
| 🏦 AML·암호화폐 | 3 | [aml-crypto/index.md](aml-crypto/index.md) |
| 🌐 이질성·스펙트럼 | 3 | [heterophily-spectral/index.md](heterophily-spectral/index.md) |
| 🛡️ 강건성·설명가능성 | 3 | [robustness-explainability/index.md](robustness-explainability/index.md) |
